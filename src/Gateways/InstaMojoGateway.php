...
class InstaMojoGateway implements PaymentGatewayInterface {
    ...
    function __construct()
    {
        ...
        $this->api_key = Config::get('payment.instamojo.api_key');
        $this->auth_token = Config::get('payment.instamojo.auth_token');

        $this->parameters['redirect_url'] = url(Config::get('payment.instamojo.redirectUrl'));
    }
    ...
    public function send()
    {
        ...
        return View::make('payment::instamojo')->with('longurl',$this->response->payment_request->longurl);
