...
class PaytmGateway implements PaymentGatewayInterface {
    ...
    {
        $this->MERCHANT_KEY = Config::get('payment.paytm.MERCHANT_KEY');
        $this->testMode = Config::get('payment.testMode');
        $this->parameters['MID'] = Config::get('payment.paytm.MID');
        $this->parameters['CHANNEL_ID'] = Config::get('payment.paytm.CHANNEL_ID');
        $this->parameters['CALLBACK_URL'] = url(Config::get('payment.paytm.REDIRECT_URL'));
        $this->parameters['WEBSITE'] = Config::get('payment.paytm.WEBSITE');
        $this->parameters['INDUSTRY_TYPE_ID'] = Config::get('payment.paytm.INDUSTRY_TYPE_ID');
    }
    ...
    public function request($parameters)
    {
        ...
        $this->parameters['CHECKSUMHASH'] = $this->getChecksumFromArray($this->parameters,$this->MERCHANT_KEY);
    ...
    public function send()
    {
        ...
        return View::make('payment::paytm')->with('params',$this->parameters)
