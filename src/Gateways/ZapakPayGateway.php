...
class ZapakPayGateway implements PaymentGatewayInterface {
    ...
    {
        $this->secret = Config::get('payment.zapakpay.secret');
        $this->merchantIdentifier = Config::get('payment.zapakpay.merchantIdentifier');
        $this->testMode = Config::get('payment.testMode');
        $this->parameters['merchantIdentifier'] = $this->merchantIdentifier;
        $this->parameters['returnUrl'] = url(Config::get('payment.zapakpay.returnUrl'));
    ...
    public function send()
    {
        ...
        return View::make('payment::zapakpay')->with('params',$this->parameters)
