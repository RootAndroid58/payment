...
class MockerGateway implements PaymentGatewayInterface {
    ...
    {
        $this->service = Config::get('payment.mocker.service');
        $this->testMode = Config::get('payment.testMode');
        $this->parameters['redirect_url'] = url(Config::get('payment.mocker.redirect_url'));
    }
    ...
    public function send()
    {
        ...
        return View::make('payment::mocker')->with('data',$this->parameters)
